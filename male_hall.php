...
<div id="right_column2">
	...
	$(document).ready(function() {
		...
		<div id="main_container">
			<div id="dashbord"><?php echo BUP_MALE_HALL; ?></div>
			<div id="description_home">
				<p class="paragraph"><?php echo BUP_MALE_HALL_DESCRIPTION; echo $usr; ?></p>
				<br />
				...
				<p class="paragraph"> Asst. Provost </br>Lecturer, Priyabrata Chowdhury, (Full-time) since 27th July 2010</p></br>
